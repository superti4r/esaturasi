...
<section class="section">
    ...
    <div class="section-body">
        <h2 class="section-title">Kelola Tahun Pelajaran</h2>
        <p class="section-lead">Tahun Pelajaran adalah inisialisasi awal dari semua data yang ada pada Sistem, silahkan set terlebih dahulu. </p>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4>Data &mdash; Tahun Pelajaran</h4>
                        <div>
