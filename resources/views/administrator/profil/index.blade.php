...
<section class="section">
    ...
    <div class="section-body">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('administrator.settings') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row">
                        ...
                        <small class="form-text text-muted col-sm-10 offset-sm-2">Kosongkan jika tidak ingin mengubah password</small>
                    </div>

                    <div class="form-group row">
                        <div class="col-sm-10 offset-sm-2 d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary mr-2">Simpan</button>
                            <a href="/administrator/settings" class="btn btn-danger">Batal</a>
                        </div>
                    </div>
                </form>
            </div>
