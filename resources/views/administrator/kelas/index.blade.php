            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4>Data &mdash; Kelas</h4>
                        <div>
                            <a href="{{ route('administrator.kelas.add') }}" class="btn btn-success btn-sm">
                            ...
                            <table class="table table-striped" id="table-kelas">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('administrator.kelas.edit', $item->id) }}" class="btn btn-primary btn-sm">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <form action="{{ route('administrator.kelas.delete', $item->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
        ...
        $('#btn-delete-selected').on('click', function() {
            ...
            if (selectedIds.length > 0) {
                Swal.fire({
                    ...
                    text: "Anda akan menghapus kelas yang dipilih!",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('administrator.kelas.bulkdelete') }}",
                            type: 'POST',
                            data: {
                ...
                Swal.fire({
                    icon: 'warning',
                    title: 'Peringatan!',
                    text: 'Pilih setidaknya satu kelas untuk dihapus.',
                    showConfirmButton: false,
                    timer: 3000
                });
            }
