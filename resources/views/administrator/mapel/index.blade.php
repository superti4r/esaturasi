...
<section class="section">
    ...
    <div class="section-body">
        <h2 class="section-title">Kelola Mata Pelajaran</h2>
        <p class="section-lead">Tambahkan Mata Pelajaran sesuai dengan data dari sekolah</p>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4>Data &mdash; Mata Pelajaran</h4>
                        <div>
                            <a href="{{ route('administrator.mapel.add') }}" class="btn btn-success btn-sm">
                            ...
                            <table class="table table-striped" id="table-mapel">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('administrator.mapel.edit', $item->id) }}" class="btn btn-primary btn-sm">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <form action="{{ route('administrator.mapel.delete', $item->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
...
<script>
        ...
        $('#btn-delete-selected').on('click', function() {
            ...
            if (selectedIds.length > 0) {
                Swal.fire({
                    ...
                    text: "Anda akan menghapus mata pelajaran yang dipilih!",
                    icon: 'warning',
                ...
                Swal.fire({
                    icon: 'warning',
                    title: 'Peringatan!',
                    text: 'Pilih setidaknya satu mata pelajaran untuk dihapus.',
                    showConfirmButton: false,
                    timer: 3000
                });
            }
    ...
    function confirmDelete(event) {
        ...
        Swal.fire({
            title: 'Apakah Anda yakin?',
            text: "Anda akan menghapus mata pelajaran ini!",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
